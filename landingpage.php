...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <nav id="navs" class="navbar navbar-expand-sm navbar-light" style="padding: .1rem 1rem; border-bottom:1px solid #cccccc; font-family:Devanagari Sangam MN;">
      <a class="navbar-brand" href="<?= base_url();?>/C_syl/index" style="margin-right:50px;  margin-bottom:30px;"><img src="Logo.png" alt="" width="90px;"> </a>
      <a class="navbar-brand" href="<?= base_url();?>/C_syl/pertolongan" style="margin-right:50px;  margin-bottom:30px;"><b>PERTOLONGAN</b></a>
      <a class="navbar-brand" href="<?= base_url();?>/index.php/forum" style="margin-right:50px;  margin-bottom:30px;"><b>FORUM</b></a>
      <a class="navbar-brand" href="<?= base_url();?>/index.php/gabung" style="margin-right:50px;  margin-bottom:30px;"><b>GABUNG</b></a>
      <a class="navbar-brand" href="<?= base_url();?>/index.php/tenagaahli" style="margin-right:50px;  margin-bottom:30px; border-right:1px solid black; width:200px;"><b>TENAGA AHLI</b></a>
    ...
    <div class="jumbotron" style="background-color:white; margin-top:50px; margin-bottom:50px;">
      <div class="container">
        <div class="row" >
          <div class="col-sm-3">
            <img src="Logo.png" alt="" width=350px; style="border-right:3px solid black; padding:50px;">
          </div>
          <div class="col">
        ...
        <div class="row" style="margin-right:65px;">
            <div id="cek" class="col-sm-2">
              <div class="card" style="border-radius:10px;">
                <div class="card-header" style="border-radius:10px;"> <img src="E:\Test codingan\HTML\TUBES MBD\Assets\YukNgobrol.png" alt="icon" width="83px;"> </div>
          ...
          <div id="cek" class="col-sm-2">
            <div class="card" style="border-radius:10px;">
              <div class="card-header" style="border-radius:10px;"> <img src="E:\Test codingan\HTML\TUBES MBD\Assets\HeartCall.png" alt="icon" width="100px;"> </div>
              <div class="card-body"><b>HeartCall</b></div>
              <div id="foter" class="card-footer" style="border-radius:10px;"><a href="<?= base_url();?>/index.php/heartcall" style="color:white">022-001-007</a></div>
            </div>
          </div>

          <div id="cek" class="col-sm-2">
            <div class="card" style="border-radius:10px;">
              <div class="card-header" style="border-radius:10px;"> <img src="E:\Test codingan\HTML\TUBES MBD\Assets\Forum.png" alt="icon" width="100px;"> </div>
              <div class="card-body"><b>Forum</b></div>
              <div id="foter" class="card-footer" style="border-radius:10px;"><a href="<?= base_url();?>/index.php/forum" style="color:white">BUKA</a></div>
            </div>
          </div>
        </div>
      </div>
