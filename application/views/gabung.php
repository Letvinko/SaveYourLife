...
<html lang="en" dir="ltr">
  ...
  <body>
      ...
      <div style="background-color:rgba(39, 212, 226,0.6); padding:200px; z-index:-1;">
        <div class="container" style="opacity:1">
          <div class="row" style="margin-top:-120px;">
            <div class="col">
              <h1 style="color:rgba(255, 255, 255, 1); font-size:60px;">Gabung Bersama Kami</h1>
            </div>
          </div>
          <div class="row">
            <div class="col">
              <p style="color:rgba(255, 255, 255, 1); line-height:80%; Margin-top:90px; font-size:20px;">Setiap orang memiliki peran untuk mencegah terjadinya bunuh</p>
              <p style="color:rgba(255, 255, 255, 1); line-height:80%; font-size:20px;">diri. Dengan bantuan anda, kami bisa menolong banyak nyawa</p>
              <p style="color:rgba(255, 255, 255, 1); line-height:80%; font-size:20px;">yang harus diselamatkan</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container-fluid">
      <div class="jumbotron jumbotron-fluid" style="padding:100px; background-color:white;">
        <h2 style="margin-bottom:40px; font-size:60px;">Mulai Dengan Hubungi Kami</h2>
        <div class="" style="line-height: 80%; font-size:20px;">
          <p >Perkenalkan Dirimu dan ceritakaan alasanmu mengapa kamu ingin bergabung</p>
          <p >Dengan kami. Hubungi lewat email di bawah ini</p>
        </div>
      </div>
    </div>

    <div class="w3-container" width="100%" style="background-color:#27D4E2; height:100px;">
      <div style="margin-top:20px;  position: relative; left: 100px;">
        <img src="<?=base_url();?>/assets/Email.png" alt="" width="70px;">
        <h4 style="display:inline-block; margin-left:30px;">saveyourlife@gmail.com</h4>
      </div>
    </div>

    <div class="container-fluid" style="margin-left:30px;">
      <div class="jumbotron jumbotron-fluid" style="padding:80px; background-color:white;">
        <h2 style="font-size:60px;">Gabung Bersama Kami Dengan Cara</h2>
        <h2 style="margin-bottom:40px; font-size:60px;">Donasi!</h2>

          <p style="line-height:80%; font-size:20px;">Anda pun dapat berkontribusi dengan cara berdonasi, donasi dari anda sangat</p>
          <p style="line-height:80%; font-size:20px;">berperan penting demi berjalannya program ini, hubungi kami lewat email</p>
          <p style="line-height:80%; font-size:20px;">di bawah ini.</p>
      </div>
    </div>
    ...
    <div class="w3-container" width="100%" style="background-color:#27D4E2; height:100px;">
      <div style="margin-top:20px;  position: relative; left: 100px;">
        <img src="<?=base_url();?>/assets/Email.png" alt="" width="70px;">
        <h4 style="display:inline-block; margin-left:30px;">donate.saveyourlife@gmail.com</h4>
      </div>
    </div>
